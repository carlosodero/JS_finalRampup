...
for (let index = 0; index < people.length; index++) {
  ...
  if (person.age >= 18 || person.age < 18 && person.isEmancipated === true || person.age >= 16 && person.age < 18 && person.isAuthorizated === true) {
    console.log(person.name + ' puede firmar un contrato de trabajo.');
  }
}